            ...
            <div class="row">
              ...
              <div class="col s12">
                <div class="carousel carousel-slider">
                  <a class="carousel-item" href="#one!">
                    <img src="{{asset('images/gallery/28.png')}}" alt="">
                  </a>
                  <a class="carousel-item" href="#two!">
                    <img src="{{asset('images/gallery/29.png')}}" alt="">
                  </a>
                  <a class="carousel-item" href="#three!">
                    <img src="{{asset('images/gallery/30.png')}}" alt="">
                  </a>
                  <a class="carousel-item" href="#four!">
                    <img src="{{asset('images/gallery/31.png')}}" alt="">
                  </a>
                </div>
              </div>
            </div>
